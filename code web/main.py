...
async def lifespan(app: FastAPI):
    try:
        ...
        # --- KHỞI TẠO TIMER ---
        global device_timer
        # Khi khởi tạo, nó sẽ gọi load_timers -> và tự động start các task nhờ đoạn code vừa sửa ở trên
        device_timer = DeviceTimer(mqtt_client)
        print("✅ Timer Service đã khởi động")
        # ----------------------
